...
public class AudioManager : MonoBehaviour {
    ...
    public float masterVolumeFraction { get; private set; } = 0.2f;
    public float sfxVolumeFraction { get; private set; } = 1;
    public float musicVolumeFraction { get; private set; } = 1;
